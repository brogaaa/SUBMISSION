...
st.sidebar.markdown("** Erik Pontian S **")
st.sidebar.markdown(
    "**• Email: [erik.pontian@gmail.com](erik.pontian@gmail.com)**")
st.sidebar.markdown(
    "**• ID Dicoding: [erik_pontian](https://www.dicoding.com/users/erik_pontian/academies)**")
st.sidebar.markdown(
    "**• Github: [brogaaa](https://github.com/brogaaa)**")
